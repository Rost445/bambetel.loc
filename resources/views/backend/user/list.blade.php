        ...
        <div class="page-breadcrumb">
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title m-0"><button type="button"
                                    class=" float-right btn waves-effect waves-light btn-rounded btn-success"><i
                                        class="mdi mdi-account-plus mr-2"></i>Додати користувача</button></h4>
                                    ...
                                    @forelse($getRecord as $value)
                                        <tr>
                                            ...
                                            <td><a onclick="return confirm('Ви дійсно хочете видалити запис?');"
                                                    href="{{ url('panel/user/delete/' . $value->id) }}" 
                                                    class="text-danger"><i class="mdi mdi-delete text-danger mr-2"></i>Видалити</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
