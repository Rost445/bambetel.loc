             ...
             <div class="col-sm-12">
                 <div class="card card-body">
                     <form class="form-horizontal m-t-30" method="post">
                         ...
                         <div class="form-group">
                             <label for="email"><strong>Електронна пошта</strong><span class="text-danger" required> *</span></label>
                             <input type="email" id="email" name="email" class="form-control">
                         </div>
                         <div class="form-group">
                             <label><strong>Пароль</strong><span class="text-danger" required> *</span></label>
