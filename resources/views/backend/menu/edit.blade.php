                 ...
                 <div class="card card-body">
                     ...
                     <form class="form-horizontal m-t-30" method="post">
                         ...
                         <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ $getRecord->name}}" required class="form-control" id="name">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="slug" value="{{ $getRecord->slug  }}" class="form-control" id="slug">
                                <div class="text-danger">{{ $errors->first('slug') }}</div>   <p class="text-muted"><small>* Можна залишити поле пустим</small></p>
                            </div>
                            
                            <div class="form-group">
                                <label for="meta_title" class="form-label">Мета Заголовок</label><span class="text-danger"> *</span>
                                <input type="text" name="meta_title" value="{{ $getRecord->meta_title }}" required class="form-control" id="meta_title">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="meta_keywords" required value="{{ $getRecord->meta_keywords }}" class="form-control" id="meta_keywords">
