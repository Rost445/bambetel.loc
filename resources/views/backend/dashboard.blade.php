                                                ...
                                                <div class="d-flex no-block align-items-center">
                                                    <div>
                                                        <i class="mdi mdi-account-multiple-plus font-20 text-muted"></i>
                                                         <a  class="text-secondary" href="{{ url('panel/user/list') }}"> <p class="font-16 m-b-5">Користувачі &nbsp; <i class="ti-arrow-right"></i></p></a>
                                                    </div>
                                                    <div class="ml-auto">
                                        ...
                                        <div class="col-md-12">
                                            <div class="d-flex no-block align-items-center">
                                                ...
                                                <div>
                                                   ...
                                                   <a  class="text-secondary" href="{{ url('panel/menu/list') }}"> <p class="font-16 m-b-5">Розділи меню &nbsp; <i class="ti-arrow-right"></i></p></a>
                                                </div>
                                                <div class="ml-auto">
                                        ...
                                        <div class="col-md-12">
                                            <div class="d-flex no-block align-items-center">
                                                <div>
                                                    ...
                                                    <a  class="text-secondary" href="{{ url('panel/assort/list') }}"> <p class="font-16 m-b-5">Ассортимент меню &nbsp; <i class="ti-arrow-right"></i></p></a>
                                                </div>
                                                <div class="ml-auto">
                                        ...
                                        <div class="col-md-12">
                                            <div class="d-flex no-block align-items-center">
                                                <div>
                                                    ...
                                                    <a  class="text-secondary" href="#"> <p class="font-16 m-b-5">Фото &nbsp; <i class="ti-arrow-right"></i></p></a>
                                                </div>
                                                <div class="ml-auto">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="d-flex no-block align-items-center">
                                                   ...
                                                   <a  class="text-secondary" href="{{ url('panel/page/list') }}"> <p class="font-16 m-b-5">Сторінки&nbsp; <i class="ti-arrow-right"></i></p></a>
                                                    </div>
                                                    <div class="ml-auto">
                                                        <h1 class="font-light text-right">23</h1>
                                                    </div>
                                                ...
                                                <div class="d-flex no-block align-items-center">
                                                    <div>
                                                        <i class="mdi mdi-comment font-20 text-muted"></i>
                                                         <a  class="text-secondary" href="{{ url('panel/comment/list') }}"> <p class="font-16 m-b-5">Відгуки &nbsp; <i class="ti-arrow-right"></i></p></a>
                                                    </div>
                                                    <div class="ml-auto">
                                                        <h1 class="font-light text-right">23</h1>
                                                    </div>
