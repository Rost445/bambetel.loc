...
<body class="index-page">
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6" data-aos="fade-up">
                        <div class="about-content">
                            ...
                            <div class="signature mt-4" data-aos="fade-up" data-aos-delay="250">
                                ...
                                <img src="{{ url('front/assets/img/misc/signature-1.webp') }}" alt="Chef Signature"
                                    class="img-fluid">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="about-gallery">
                            <div class="row g-3">
                                <div class="col-6">
                                    <img src="{{ url('front/assets/img/restaurant/showcase-3.webp') }}" class="img-fluid rounded"
                                        alt="Restaurant Image">
                                </div>
                                <div class="col-6">
                                    <img src="{{ url('front/assets/img/restaurant/showcase-8.webp') }}" class="img-fluid rounded"
                                        alt="Restaurant Image">
                                </div>
                                <div class="col-12 mt-3">
                                    ...
                                    <img src="{{ url('front/assets/img/restaurant/showcase-6.webp') }}" class="img-fluid rounded"
                                        alt="Restaurant Image">
                                </div>
                            </div>
                        </div>
                ...
                <div class="isotope-layout" data-default-filter="*" data-layout="masonry"
                    ...
                    <div class="menu-grid isotope-container row gy-5" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-starters">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="{{ url('front/assets/img/restaurant/starter-1.webp') }}" alt="Appetizer"
                                        class="img-fluid">
                                ...
                                <div class="menu-card-content">
                                    ...
                                    <p>Vivamus tempor magna et tempus elementum. Sed consequat libero vel mauris cursus.
                                    </p>
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-starters">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="{{ url('front/assets/img/restaurant/starter-3.webp') }}" alt="Appetizer"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-main">
                            <div class="menu-card featured">
                                <div class="menu-card-image">
                                    <img src="{{ url('front/assets/img/restaurant/main-2.webp') }}" alt="Main Course"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-main">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="{{ url('front/assets/img/restaurant/main-6.webp') }}" alt="Main Course"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                                        <span class="badge-vegetarian">V</span>
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-dessert">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="{{ url('front/assets/img/restaurant/dessert-4.webp') }}" alt="Dessert"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-dessert">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="{{ url('front/assets/img/restaurant/dessert-9.webp') }}" alt="Dessert"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-drinks">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="{{ url('front/assets/img/restaurant/drink-2.webp') }}" alt="Beverage"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-drinks">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="{{ url('front/assets/img/restaurant/drink-6.webp') }}" alt="Beverage"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                ...
                <div class="chef-recommendations" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="recommendation-card">
                                <div class="recommendation-image">
                                    <img src="{{ url('front/assets/img/restaurant/main-9.webp') }}" alt="Chef Recommendation"
                                        class="img-fluid">
                        ...
                        <div class="col-lg-6">
                            <div class="recommendation-card">
                                <div class="recommendation-image">
                                    <img src="{{ url('front/assets/img/restaurant/main-8.webp')}}" alt="Chef Recommendation"
                                        class="img-fluid">
                                    <div class="chef-badge">
                                        <i class="bi bi-award"></i>
                                        <span>Chef's Pick</span>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>Proin iaculis purus consequat sem cure digni ssim donec porttitora entum suscipit
                                    ...
                                    risus at semper.</p>
                                <div class="profile">
                                    <img src="{{ url('front/assets/img/person/person-m-9.webp') }}" class="testimonial-img"
                                        alt="" loading="lazy">
                                    <div class="info">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>Enim nisi quem export duis labore cillum quae magna enim sint quorum nulla quem
                                    veniam duis minim tempor labore quem eram duis noster aute amet eram fore quis sint
                                    minim.</p>
                                <div class="profile">
                                    <img src="{{ url('front/assets/img/person/person-f-5.webp') }}" class="testimonial-img"
                                        alt="" loading="lazy">
                                    <div class="info">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>Fugiat enim eram quae cillum dolore dolor amet nulla culpa multos export minim fugiat
                                    ...
                                    labore.</p>
                                <div class="profile">
                                    <img src="{{ url('front/assets/img/person/person-f-12.webp' ) }}" class="testimonial-img"
                                        alt="" loading="lazy">
                                    <div class="info">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>Quis quorum aliqua sint quem legam fore sunt eram irure aliqua veniam tempor noster
                                    ...
                                    culpa.</p>
                                <div class="profile">
                                    <img src={{ url('front/assets/img/person/person-m-12.webp') }}" class="testimonial-img"
                                        alt="" loading="lazy">
                                    <div class="info">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>Export tempor illum tamen malis malis eram quae irure esse labore quem cillum quid
                                    cillum eram malis quorum velit fore eram velit sunt aliqua noster fugiat irure amet
                                    legam anim culpa.</p>
                                <div class="profile">
                                    <img src="{{ url('front/assets/img/person/person-m-13.webp') }}" class="testimonial-img"
                                        alt="" loading="lazy">
                                    <div class="info">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>Texit tempor illum tamen malis malis eram quae irure esse labore quem cillum quid
                                    cillum eram malis quorum velit fore eram velit sunt aliqua noster fugiat irure amet
                                    legam anim culpa.</p>
                                <div class="profile">
                                    <img src="{{ url('front/assets/img/person/person-f-13.webp') }}" class="testimonial-img"
                                        alt="" loading="lazy">
                                    <div class="info">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="featured-chef row align-items-center g-4" data-aos="fade-up" data-aos-delay="150">
                    <div class="col-lg-5">
                        <figure class="chef-photo m-0">
                            <img src="{{ url('front/assets/img/restaurant/chef-4.webp') }}" alt="Executive chef portrait"
                                class="img-fluid">
                    ...
                    <div class="col-lg-7">
                        <div class="chef-content">
                            ...
                            <p class="bio mb-4">Curabitur convallis lectus a sapien dictum, sed posuere urna fermentum.
                                Maecenas sodales, neque non pretium ultrices, lacus nibh finibus mi, non vulputate arcu
                                quam at nisl.</p>
                            ...
                            <ul class="awards list-unstyled d-flex flex-wrap gap-2 mb-4">
                                ...
                                <li class="award-badge"><i class="bi bi-bookmark-star me-1"></i> Le Cordon Bleu Honors
                                </li>
                ...
                <div class="row g-4 team-grid mt-2">
                    ...
                    <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="200">
                        <article class="chef-card h-100">
                            <div class="image-wrapper">
                                <img src="{{ url('front/assets/img/restaurant/chef-1.webp') }}" alt="Sous chef portrait"
                                    class="img-fluid" loading="lazy">
                                <ul class="social list-unstyled m-0">
                                    <li><a href="#" aria-label="Instagram"><i class="bi bi-instagram"></i></a>
                                    </li>
                                    <li><a href="#" aria-label="Twitter"><i class="bi bi-twitter-x"></i></a>
                                    </li>
                            ...
                            <div class="content p-3">
                                ...
                                <p class="excerpt mb-3">Donec feugiat, arcu non pulvinar posuere, risus libero cursus
                                    nibh, sed dictum nibh arcu non augue.</p>
                    ...
                    <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="250">
                        <article class="chef-card h-100">
                            <div class="image-wrapper">
                                <img src="{{ url('front/assets/img/restaurant/chef-6.webp') }}" alt="Pastry chef portrait"
                                    class="img-fluid" loading="lazy">
                                <ul class="social list-unstyled m-0">
                                    <li><a href="#" aria-label="Instagram"><i class="bi bi-instagram"></i></a>
                                    </li>
                                    ...
                                    <li><a href="#" aria-label="Pinterest"><i class="bi bi-pinterest"></i></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="content p-3">
                    ...
                    <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="300">
                        <article class="chef-card h-100">
                            <div class="image-wrapper">
                                <img src="{{ url('front/assets/img/restaurant/chef-8.webp') }}" alt="Grill chef portrait"
                                    class="img-fluid" loading="lazy">
                                <ul class="social list-unstyled m-0">
                                    <li><a href="#" aria-label="Instagram"><i class="bi bi-instagram"></i></a>
                                    </li>
                            ...
                            <div class="content p-3">
                                ...
                                <p class="excerpt mb-3">Pellentesque dapibus, nibh id pharetra interdum, risus est
                                    vehicula lectus, non iaculis velit elit ut felis.</p>
                                <div class="badges d-flex flex-wrap gap-2">
                    ...
                    <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="350">
                        <article class="chef-card h-100">
                            <div class="image-wrapper">
                                <img src="{{ url('front/assets/img/restaurant/chef-3.webp' ) }}" alt="Line cook portrait"
                                    class="img-fluid" loading="lazy">
                                <ul class="social list-unstyled m-0">
                                    <li><a href="#" aria-label="Instagram"><i class="bi bi-instagram"></i></a>
                                    </li>
                            ...
                            <div class="content p-3">
                                ...
                                <p class="excerpt mb-3">Vestibulum congue, justo eget ultricies posuere, erat nunc
                                    viverra arcu, vitae cursus arcu nunc at erat.</p>
                                <div class="badges d-flex flex-wrap gap-2">
                                    <span class="mini-badge"><i class="bi bi-emoji-smile me-1"></i> Guest
                                        Favorite</span>
                                </div>
                            </div>
                        </article>
                                        ...
                                        <form action="forms/book-a-table.php" method="post" role="form"
                                            ...
                                            <div class="my-3">
                                                ...
                                                <div class="sent-message">Your reservation request has been submitted
                                                    successfully. Well contact you shortly to confirm.
                                                    </div>
                                            </div>
                                ...
                                <div class="col-lg-7" data-aos="fade-left" data-aos-delay="300">
                                    <div class="reservation-info-section">
                                        <div class="hero-image">
                                            <img src="{{ url('front/assets/img/restaurant/showcase-2.webp') }}"
                                                alt="Restaurant dining area" class="img-fluid">
                ...
                <div class="row g-4 mb-5" data-aos="fade-up" data-aos-delay="200">
                    <div class="col-lg-6" data-aos="slide-right" data-aos-delay="250">
                        <div class="feature-card primary">
                            <div class="feature-visual">
                                <img src="{{ url('front/assets/img/restaurant/misc-3.webp') }}" alt="Special Menu"
                                    class="img-fluid">
                            ...
                            <div class="feature-content">
                                ...
                                <a href="#" class="feature-link">Explore Menu <i
                    ...
                    <div class="col-lg-6" data-aos="slide-left" data-aos-delay="300">
                        <div class="feature-card secondary">
                            <div class="feature-visual">
                                <img src="{{ url('front/assets/img/restaurant/misc-7.webp') }}" alt="Wine Pairing"
                                    class="img-fluid">
                                <div class="feature-badge">
                            ...
                            <div class="feature-content">
                                ...
                                <a href="#" class="feature-link">Book Tasting <i
                                        class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="250">
                            <div class="awards-content">
                                ...
                                <p>At enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
                    ...
                    <div class="row g-3 isotope-container" data-aos="fade-up" data-aos-delay="200">
                        <div class="col-lg-4 col-md-6 isotope-item filter-food">
                            <figure class="gallery-card">
                                <a href="{{ url('front/assets/img/restaurant/main-3.webp') }}" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="{{ url('front/assets/img/restaurant/main-3.webp') }}" alt="Grilled Salmon"
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-interior">
                            <figure class="gallery-card">
                                <a href="{{ url('front/assets/img/restaurant/showcase-2.webp') }}" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="{{ url('front/assets/img/restaurant/showcase-2.webp') }}" alt="Dining Hall"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-staff">
                            <figure class="gallery-card">
                                <a href="{{ url('front/assets/img/restaurant/chef-5.webp') }}" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="{{ url('front/assets/img/restaurant/chef-5.webp') }}" alt="Chef Maria"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-drinks">
                            <figure class="gallery-card">
                                <a href="{{ url('front/assets/img/restaurant/drink-2.webp') }}" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="{{ url('front/assets/img/restaurant/drink-2.webp') }}" alt="Signature Mocktail"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-food">
                            <figure class="gallery-card">
                                <a href="front/assets/img/restaurant/dessert-4.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="front/assets/img/restaurant/dessert-4.webp" alt="Raspberry Tart"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-interior">
                            <figure class="gallery-card">
                                <a href="front/assets/img/restaurant/showcase-5.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="front/assets/img/restaurant/showcase-5.webp" alt="Bar Area"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-staff">
                            <figure class="gallery-card">
                                <a href="front/assets/img/restaurant/chef-2.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="front/assets/img/restaurant/chef-2.webp" alt="Sous Chef Daniel"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-drinks">
                            <figure class="gallery-card">
                                <a href="front/assets/img/restaurant/drink-8.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="front/assets/img/restaurant/drink-8.webp" alt="Classic Espresso"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-food">
                            <figure class="gallery-card">
                                <a href="front/assets/img/restaurant/main-7.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="front/assets/img/restaurant/main-7.webp" alt="Beef Fillet"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <div class="input-with-icon">
                                                ...
                                                <textarea class="form-control" name="message" placeholder="Write Message..." style="height: 180px"
                                                    required=""></textarea>
                                            </div>
                                        </div>
                                    </div>
    ...
    <!-- Vendor JS Files -->
    <script src="front/assetsvendor/bootstrap/js/bootstrap.bundle.min.js"></script>
