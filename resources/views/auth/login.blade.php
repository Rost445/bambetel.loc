                            ...
                            <form class="form-horizontal m-t-20" id="loginform" action="{{ url('') }}">
                                ...
                                <div class="form-group text-center">
                                    <div class="col-xs-12 p-b-20">
                                        <button class="btn btn-block btn-lg btn-info" type="submit">Вхід</button>
                                    </div>
                                </div>

                                <div class="form-group m-b-0 m-t-10">
                                    <div class="col-sm-12 text-center">
                                        Немає облікового запису? <a href="{{ route('register') }}"
                                            class="text-info m-l-5"><b>Реєстрація</b></a>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="row m-t-20">
                                <div class="col-12">
                                    <button class="btn btn-block btn-lg btn-danger" type="submit"
                                        name="action">відновити </button>
                                </div>
                                <div class="col-12 text-left my-3 mx-2">
                                    <a href="{{ route('login') }}" id="to-recover"
                                        class="text-dark text-decoration-underline">
                                        <i class="fa fa-lock m-r-5"></i> Вхід в
                                            свій акаунт
                                    </a>
